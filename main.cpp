...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Equibit-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.equibit.org", "eqb-dnsseed.horlacher.ca", ""};
static const string testnet_seeds[] = {"testnet-dnsseed.equibit.org", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 8331), true);
  }
  do {
